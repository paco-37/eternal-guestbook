...
export declare namespace Guestbook {
  ...
  export type EntryStructOutput = [
    ...
    message: string,
    timestamp: bigint
  ] & { writer: string; message: string; timestamp: bigint };
}

export interface GuestbookInterface extends Interface {
  getFunction(
    nameOrSignature: "entries" | "getAllEntries" | "writeMessage"
  ): FunctionFragment;
...
export interface Guestbook extends BaseContract {
  ...
  writeMessage: TypedContractMethod<[_message: string], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[], [Guestbook.EntryStructOutput[]], "view">;
  getFunction(
    nameOrSignature: "writeMessage"
  ): TypedContractMethod<[_message: string], [void], "nonpayable">;

  getEvent(
    key: "NewEntry"
  ): TypedContractEvent<
    NewEntryEvent.InputTuple,
    NewEntryEvent.OutputTuple,
    NewEntryEvent.OutputObject
  >;

  filters: {
    "NewEntry(address,string,uint256)": TypedContractEvent<
      NewEntryEvent.InputTuple,
      NewEntryEvent.OutputTuple,
      NewEntryEvent.OutputObject
    >;
    NewEntry: TypedContractEvent<
      NewEntryEvent.InputTuple,
      NewEntryEvent.OutputTuple,
      NewEntryEvent.OutputObject
    >;
